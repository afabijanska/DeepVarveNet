...
from models import getSampleModel2
...
#define callbacks 
checkpointer = ModelCheckpoint(main_dir + 'best_weights_org_2.h5', verbose=1, monitor='val_loss', mode='auto', save_best_only=True) 
tbCallback = TensorBoard(log_dir='./logs', histogram_freq=0, write_graph=True, write_images=True)

#get model
model = getSampleModel2(2, (rows,cols,n_ch))
...
model.save_weights('last_weights_org_2.h5', overwrite=True)
